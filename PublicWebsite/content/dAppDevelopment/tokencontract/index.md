...
```
$./cleos -H ec2-34-238-254-245.compute-1.amazonaws.com -p 8888  create account eosio eosio.token EOS7HcuW6uqhYSwhhoPi81XpjRPNzkfcU63CYtk95qyY65EVGEK1y EOS5qi7Fo9CdPXhtdcw6HNL7UMzmASdxJotmCATbhXwCqiFJxTX3o
...
```
$./cleos -H ec2-34-238-254-245.compute-1.amazonaws.com -p 8888 set contract eosio.token ~/dev/eos/build/contracts/eosio.token -p eosio.token
...
```
$./cleos -H ec2-34-238-254-245.compute-1.amazonaws.com -p 8888 push action eosio.token create '{"issuer":"eosio", "maximum_supply":"1000000000.0000 EOS", "can_freeze":0, "can_recall":0, "can_whitelist":0}' -p eosio.token
